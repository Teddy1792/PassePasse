...
export function Apropos() {
    return(
        <nav>
            ...
            <p className='aPropos'>Association créée en 2023, les Éditions Passe·passe cherchent à mettre en lumière quelque vision du monde susceptible, pour le dire avec une présomptueuse ambition et des moyens minimalistes, de réajuster le réel. Autrement dit, chaque livre offre un point de vue singulier sur l’environnement qui l’entoure et une manière propre de l’habiter.
